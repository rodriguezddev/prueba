<template>
  <div data-test="payment-cart-resume">
    <div class="card my-5 mx-3 just-desktop">
      <div class="card-body">
        <div class="line mb-4">
        ...
        <div class="plans mx-4 px-2">
          ...
          <div class="row mb-4">
            ...
            <div class="col-md-4">
              <p
                class="mt-2 font-weight-bold cursor-pointer text-blue"
        ...
        <div class="total mx-4 px-2">
          ...
          >
            ...
            <div
              ...
              :key="index"
              class="ml-3 w-100 d-flex justify-content-between"
            >
              <p
                v-if="addon.count > 0"
                class="mb-0"
        ...
        <div class="row mt-4 mb-3 justify-content-center mx-4 px-2">
          ...
          >Esta es una suscripción anual con renovación automática al término
            ...
            llamando al 55 3986 2354.</small>
        </div>
      </div>
    </div>

    <div class="card my-5 just-mobile">
      <payment-cart-resume-mobile />
    </div>
  </div>
</template>

<script>
import PaymentCartResumeMobile from "./PaymentCartResumeMobile.vue";
import {paymentCartResume} from "../mixins/paymentCartResume";

export default {
  name: "PaymentCartResume",

  components: { PaymentCartResumeMobile },
